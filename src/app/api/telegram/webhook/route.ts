...
import { isValidTelegramWebhookSecret, sendTelegramBotMessage } from "@/shared/lib/telegram/bot-api";
  ...
  try {
    ...
    if (message.text?.startsWith("/start")) {
      await sendTelegramBotMessage(
        message.chat.id,
        `Assalomu alaykum, ${fullName(user)}! 👋\n\nJobTop — kunlik ishlarni topish platformasi. Ro‘yxatdan o‘tish uchun telefon raqamingizni yuboring.`,
        contactKeyboard,
      );
